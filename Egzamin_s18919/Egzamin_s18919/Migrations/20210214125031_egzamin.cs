...
{
    public partial class egzamin : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("IdDoctor_PK", x => x.IdDoctor);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPrescrioption = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("IdPrescription_PK", x => x.IdPrescrioption);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "IdPrescrioption",
                        onDelete: ReferentialAction.Restrict);
                });
